      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          >
            ...
            <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.projects}+</div>
          ...
          >
            ...
            <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.clients}+</div>
          ...
          >
            ...
            <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">{counts.experience}+</div>
...
function FloatingActionButton() {
  ...
  return (
    <motion.button
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-lavender to-pink text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center ${
